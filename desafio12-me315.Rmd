...
output:
  pdf_document:
    ...
    toc: TRUE
    toc_depth: 4
header-includes: \DefineVerbatimEnvironment{Highlighting}{Verbatim}{breaklines,commandchars=\\\{\}}
---
...
> Desafio 12 proposto na 20.ª aula de ME315-2S2025.
...
## Inicia sessão python
   ...
   if(!virtualenv_exists(venv_python)){ virtualenv_create(venv_python, packages = c("pip", "setuptools")) }
