...
\begin{center}
   $\Delta t^\prime=\symtt{t1-t0}=$ `r d1=difftime(t1,t0,units = "secs"); d1` $s$
\end{center}
...
\begin{center}
   $\Delta t^{\prime\prime}=$ `r difftime(t1,t0,units = "secs")` $s$
\end{center}

\begin{center}
   $\Delta t=\Delta t^\prime+\Delta t^{\prime\prime}=$ `r d1+difftime(t1,t0,units = "secs")` $s$
\end{center}
